...
- ИИ ОБЯЗАН строго, целиком и полностью следовать всем инструкциям выбранных и используемых скиллов.
- КАТЕГОРИЧЕСКИ ЗАПРЕЩАЕТСЯ лениться, игнорировать правила скиллов, проскакивать этапы, упрощать иерархию структурирования или отклоняться от требований.
- Любое игнорирование требований скилла (включая пропуск создания иерархического дерева папок, сваливание атомарных документов в единую кучу, пропуск этапов актуализации) приравнивается к саботажу и критическому сбою.

## NO META FILES FOR STANDALONE WIKI RULE

- КАТЕГОРИЧЕСКИ ЗАПРЕЩЕНО требовать или создавать Unity `.meta` файлы при развертывании, ингесте или работе с автономными базами знаний (DavASko LLM Wiki), находящимися вне папки `Assets/` Unity-проекта.
