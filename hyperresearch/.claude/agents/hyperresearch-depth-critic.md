...
1. **List the interim notes.** Use
   `E:/UnityProjects/IRI/dentistry-cow/Assets/KBPro/kbpro-ai-docs/hyperresearch/.venv/Scripts/hyperresearch.exe note list --tag <vault_tag> --type interim --all -j` to find
