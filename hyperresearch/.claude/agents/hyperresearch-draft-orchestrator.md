...
1. **Batch-read in chunks of 5-8 IDs.** Stay within output limits:
   ```bash
   PYTHONIOENCODING=utf-8 E:/UnityProjects/IRI/dentistry-cow/Assets/KBPro/kbpro-ai-docs/hyperresearch/.venv/Scripts/hyperresearch.exe note show <id1> <id2> <id3> <id4> <id5> -j
   ```
