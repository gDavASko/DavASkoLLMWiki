...
1. **Start with the vault.** Before fetching anything new, read the notes
   ...
   `E:/UnityProjects/IRI/dentistry-cow/Assets/KBPro/kbpro-ai-docs/hyperresearch/.venv/Scripts/hyperresearch.exe note show <id1> <id2> <id3> --json`
...
3. **Fetch new sources via the fetcher subagent.** Do NOT call
   `E:/UnityProjects/IRI/dentistry-cow/Assets/KBPro/kbpro-ai-docs/hyperresearch/.venv/Scripts/hyperresearch.exe fetch` directly. Delegate to `hyperresearch-fetcher` via the
...
5. **Read the fetched sources.** Use `E:/UnityProjects/IRI/dentistry-cow/Assets/KBPro/kbpro-ai-docs/hyperresearch/.venv/Scripts/hyperresearch.exe note show <id> -j`. Quote
...
6. **Write ONE interim report note.** This is your single deliverable.
   ...
   **BEFORE calling `note new`**, check if an interim note for this locus
   ...
   ```bash
   E:/UnityProjects/IRI/dentistry-cow/Assets/KBPro/kbpro-ai-docs/hyperresearch/.venv/Scripts/hyperresearch.exe note list --tag locus-<locus-name> --type interim --all --json
   ```
...
```bash
E:/UnityProjects/IRI/dentistry-cow/Assets/KBPro/kbpro-ai-docs/hyperresearch/.venv/Scripts/hyperresearch.exe note new "Interim report — <locus name>" \
  --tag <corpus_tag> \
