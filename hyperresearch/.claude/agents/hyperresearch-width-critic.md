...
1. **Survey the vault.** Use
   `E:/UnityProjects/IRI/dentistry-cow/Assets/KBPro/kbpro-ai-docs/hyperresearch/.venv/Scripts/hyperresearch.exe note list --tag <vault_tag> --all -j` to list every note.
