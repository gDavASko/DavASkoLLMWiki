...
2. **Search the vault for counter-evidence.** Use
   `E:/UnityProjects/IRI/dentistry-cow/Assets/KBPro/kbpro-ai-docs/hyperresearch/.venv/Scripts/hyperresearch.exe search "<keyword>" --tag <vault_tag> -j` to find interim
   ...
   (`E:/UnityProjects/IRI/dentistry-cow/Assets/KBPro/kbpro-ai-docs/hyperresearch/.venv/Scripts/hyperresearch.exe note show <id> -j`).
