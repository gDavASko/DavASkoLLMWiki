...
- **source_note_id**: the vault note id of the source you will analyze
  ...
  will call `E:/UnityProjects/IRI/dentistry-cow/Assets/KBPro/kbpro-ai-docs/hyperresearch/.venv/Scripts/hyperresearch.exe note show <source_note_id> -j` to read the
  full body.
...
1. **Check for an existing analysis.** Before writing anything, search:
   ```bash
   PYTHONIOENCODING=utf-8 E:/UnityProjects/IRI/dentistry-cow/Assets/KBPro/kbpro-ai-docs/hyperresearch/.venv/Scripts/hyperresearch.exe note list --tag <vault_tag> --type source-analysis --all --json
   ```
...
2. **Read the source.** Pull the full body:
   ```bash
   PYTHONIOENCODING=utf-8 E:/UnityProjects/IRI/dentistry-cow/Assets/KBPro/kbpro-ai-docs/hyperresearch/.venv/Scripts/hyperresearch.exe note show <source_note_id> -j
   ```
...
5. **Create the source-analysis note:**
   ```bash
   PYTHONIOENCODING=utf-8 E:/UnityProjects/IRI/dentistry-cow/Assets/KBPro/kbpro-ai-docs/hyperresearch/.venv/Scripts/hyperresearch.exe note new "Source Analysis — <short title>" \
