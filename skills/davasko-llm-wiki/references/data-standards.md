...
- **Dependencies Paths**: Manifests or documentation explaining layer dependencies must include absolute/relative paths to the target dependency folder (e.g., `[kbpro-wiki](file:///path/to/kbpro-wiki)`).
