...
5. **Принцип обобщенности (Generalization)**: Общие правила, инструкции и схемы не должны содержать жестко закодированных названий проприетарных фреймворков или чужих проектов (таких как KBPro). Вся информация должна храниться в обобщенном, абстрагированном и переносимом виде.
