...
Этот каталог — **единственный источник правды** для настроек всех ИИ-ассистентов в проектах DavASko.
...
2. Закоммить изменения в сабмодуле `davasko-ai-docs`
...
При клонировании нового проекта с сабмодулем `davasko-ai-docs`:
```powershell
