...
- Если вопрос касается AI rules/wiki/Bitrix/операционных правил — сначала читай `Assets/DavASko/davasko-ai-docs/llm-wiki/wiki/maps/operations-map.md`
- Если вопрос касается стиля кода — читай `Assets/DavASko/davasko-ai-docs/davasko-wiki/raw/code_style.md`
