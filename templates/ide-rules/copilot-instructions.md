...
- Если вопрос касается AI rules/wiki/Bitrix/операционных правил — сначала читай `Assets/KBPro/kbpro-ai-docs/kbpro-wiki/wiki/maps/operations-map.md`
- Если вопрос касается стиля кода — читай `Assets/KBPro/kbpro-ai-docs/unity-wiki/raw/code_style.md`
