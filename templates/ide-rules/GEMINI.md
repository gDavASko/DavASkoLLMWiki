...
- For AI rules, wiki maintenance, Bitrix import, and operational guardrails, start from `Assets/DavASko/davasko-ai-docs/davasko-wiki/wiki/maps/operations-map.md`.
...
- Follow `Assets/DavASko/davasko-ai-docs/unity-wiki/raw/code_style.md` for naming and formatting.
