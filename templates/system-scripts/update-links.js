...
function main() {
  ...
  const rawMappings = {
    // raw files
    'raw/project-docs/code_style.md': 'kbpro-wiki/raw/code_style.md',
    'raw/project-docs/code_style.md.meta': 'kbpro-wiki/raw/code_style.md.meta',
    'unity-wiki/raw/code_style.md': 'kbpro-wiki/raw/code_style.md',
    'unity-wiki/raw/code_style.md.meta': 'kbpro-wiki/raw/code_style.md.meta',
    ...
    'kbpro-wiki/raw/ExecPlan_ScenarioGraph_Stabilization.md': 'plans/ExecPlan_ScenarioGraph_Stabilization.md',
    'kbpro-wiki/raw/ExecPlan_ScenarioGraph_Stabilization.md.meta': 'plans/ExecPlan_ScenarioGraph_Stabilization.md.meta',
    'kbpro-wiki/raw/ExecPlan_ModuleSystem_Stabilization.md': 'plans/ExecPlan_ModuleSystem_Stabilization.md',
    'kbpro-wiki/raw/ExecPlan_ModuleSystem_Stabilization.md.meta': 'plans/ExecPlan_ModuleSystem_Stabilization.md.meta',
    ...
    'kbpro-wiki/raw/Architecture/Skills/CodeReviewSkillCreatePlan.md': 'plans/CodeReviewSkillCreatePlan.md',
    'kbpro-wiki/raw/Architecture/Skills/CodeReviewSkillCreatePlan.md.meta': 'plans/CodeReviewSkillCreatePlan.meta',
  ...
  const layers = ['llm-wiki', 'unity-wiki', 'kbpro-wiki', 'dentistry-cow-wiki', 'plombir-buildings-wiki', 'railway-wiki'];
  ...
  filesToScan.forEach(f => {
    ...
    if (codeStylePattern.test(content)) {
      content = content.replace(codeStylePattern, 'kbpro-wiki/raw/code_style.md');
      changed = true;
    }
